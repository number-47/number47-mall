...
public class ${table.controllerName} {
    ...
    * @return: com.number47.mall.common.CommonResult<java.util.List<com.number47.mall.model.brand.entity.${entity}>>
    * @Author: ${author}
    * @Date: ${date}
    */
    <#if swagger2>
    ...
    * @return: com.number47.mall.common.CommonResult<CommonPage<${entity}>>
    * @Author: ${author}
    * @Date: ${date}
    */
    <#if swagger2>
    ...
    * @Param: [id]
    * @return: com.number47.mall.common.CommonResult<com.number47.mall.model.brand.entity.${entity}>
    * @Author: ${author}
    * @Date: ${date}
    */
    <#if swagger2>
